          ...
          <nav className="flex justify-between items-center">
            <div>
              <ul className="md:items-center md:gap-8 hidden sm:flex">
                <li className="hover:transition ease-in transform hover:scale-105">
                  <NavLink
                    to="/"
                    className={({ isActive }) =>
                ...
                <div className="hidden sm:flex items-center">
                  <NavLink to="/profile">
                    {currentUser ? (
                      ...
                      <button className="bg-[#87acec] text-white px-5 p-1 rounded-full hover:bg-[#262627] hidden sm:flex">
                        Sign in
                      </button>
                    )}
                  </NavLink>
            ...
            <div className="md:hidden">
              ...
              >
                <MenuItem component={Link} to="/about" onClick={toggleSidebar}>
                  About
                </MenuItem>
                <MenuItem
                  component={Link}
                ...
                <MenuItem component={Link} to="/signin" onClick={toggleSidebar}>
                  Sign In
                </MenuItem>
              </Menu>
            </div>
