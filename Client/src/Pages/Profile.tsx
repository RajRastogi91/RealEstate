...
const Profile: React.FC = () => {
  ...
  const handleSignOut = async () => {
    try {
      ...
      const res = await fetch(
        "https://newrealestate.onrender.com/auth/signout"
      );
  ...
  const handleUpdate = async (e: any) => {
    try {
      ...
      const updatedFormData = {
        ...formData,
        avatar: formData.avatar || decodedval.photourl,
      };
  ...
  return (
    <div className="flex flex-col md:flex-row items-center md:items-start justify-center md:justify-start">
      ...
      <div className="p-3 my-8 w-full md:w-1/3 max-w-full rounded-lg mx-auto shadow-gray-400 shadow-md">
